...
public class ShurikenAssemblyGeoModel extends GeoModel<ShurikenAssembly> {
    private static final ResourceLocation modelResource = new ResourceLocation(Main.MODID, "geo/shuriken_assembly.geo.json");
    private static final ResourceLocation textureResource = new ResourceLocation(Main.MODID, "textures/entity/blaze_rod.png");
    private static final ResourceLocation animationResource = new ResourceLocation(Main.MODID, "animations/shuriken_assembly.animation.json");
