...
public class BlazeSentryGeoModel extends GeoModel<BlazeSentry> {
    ...
    private static final ResourceLocation textureResource = new ResourceLocation(MODID, "textures/entity/blaze_sentry.png");
    private static final ResourceLocation animationResource = new ResourceLocation(MODID, "animations/blaze_sentry.animation.json");
