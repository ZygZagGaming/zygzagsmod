...
public class IridiumGolemGeoModel extends GeoModel<IridiumGolem> {
    ...
    private static final ResourceLocation textureResource = new ResourceLocation(MODID, "textures/entity/iridium_golem.png");
    private static final ResourceLocation animationResource = new ResourceLocation(MODID, "animations/iridium_golem.animation.json");
