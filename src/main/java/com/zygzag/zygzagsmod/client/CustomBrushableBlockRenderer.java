...
public class CustomBrushableBlockRenderer implements BlockEntityRenderer<CustomBrushableBlockEntity> {
    ...
    public CustomBrushableBlockRenderer(BlockEntityRendererProvider.Context pContext) {
        this.itemRenderer = pContext.getItemRenderer();
    }

    public void render(CustomBrushableBlockEntity pBlockEntity, float pPartialTick, PoseStack pPoseStack, MultiBufferSource pBuffer, int pPackedLight, int pPackedOverlay) {
        //Main.LOGGER.info("deez nuts");
