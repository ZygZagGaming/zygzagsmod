...
public class Main {
    ...
    public static final TagKey<EntityType<?>> SCULK_JAW_IMMUNE = TagKey.create(ForgeRegistries.Keys.ENTITY_TYPES, new ResourceLocation("zygzagsmod:sculk_jaw_immune"));
