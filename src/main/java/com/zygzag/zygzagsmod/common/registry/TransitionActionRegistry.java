...
public class TransitionActionRegistry extends CustomAkomiRegistry<TransitionAction> {
    ...
    public static class BlazeSentry {
        ...
        public static final Supplier<TransitionAction> FLAMETHROW_BASE_TO_IDLE_BASE = INSTANCE.register("blaze_sentry_flamethrow_base_to_idle_base", () -> new TransitionAction(ActionRegistry.BlazeSentry.FLAMETHROW_BASE.get(), ActionRegistry.BlazeSentry.IDLE_BASE.get(), RawAnimation.begin().thenPlay("animation.blaze_sentry.flamethrow_to_idle"), 40, (ticks) -> 1f, true));
