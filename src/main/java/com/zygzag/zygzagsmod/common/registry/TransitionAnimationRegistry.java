...
public class TransitionAnimationRegistry extends CustomAkomiRegistry<TransitionAnimation> {
    ...
    public static class BlazeSentry {
        ...
        public static final Supplier<TransitionAnimation> AGRO_BASE_TO_SHOOT_BIG_BASE = INSTANCE.register("blaze_sentry_agro_base_to_shoot_big_base", () -> new TransitionAnimation(AnimationRegistry.BlazeSentry.AGRO_BASE.get(), AnimationRegistry.BlazeSentry.SHOOT_BIG_BASE.get(), RawAnimation.begin().thenPlay("animation.blaze_sentry.start_shooting"), 60, (ticks) -> 1f));
        public static final Supplier<TransitionAnimation> SHOOT_BIG_BASE_TO_AGRO_BASE = INSTANCE.register("blaze_sentry_shoot_big_base_to_agro_base", () -> new TransitionAnimation(AnimationRegistry.BlazeSentry.SHOOT_BIG_BASE.get(), AnimationRegistry.BlazeSentry.AGRO_BASE.get(), RawAnimation.begin().thenPlay("animation.blaze_sentry.stop_shooting"), 60, (ticks) -> 1f));
